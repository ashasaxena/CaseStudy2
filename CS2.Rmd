...
## In this step JAA has conducted preliminary data exploration fromt the data provided (procrastination.csv) by the United Nations.  The data consists of 4,264 individual observations and 61 variables, all of which are fully explained in the Codebook.csv file provided as specified in Asha Saxena's Github account. 
...
#Step 2: Data Scraping: Gather the data from the specified website to bring in the HDI metrics
